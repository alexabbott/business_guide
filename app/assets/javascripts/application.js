...
function getRating(){
	...
	var price = document.getElementById('restaurant_price').value
	var classification = document.getElementById('restaurant_category').value
	var output = 0;
	...
	output = (rate(latitude,longitude,price,classification));
